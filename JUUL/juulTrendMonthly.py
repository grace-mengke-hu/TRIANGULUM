...
counts, bins, patches = ax.hist([UTCjuul], bins=monthlyBin,color=['bisque'],label=['Juul'])
...
plt.title('Juul Monthly Usage Trend from 2013 to 2018')
plt.ylabel('Number of Juul Related Post')
plt.show()
