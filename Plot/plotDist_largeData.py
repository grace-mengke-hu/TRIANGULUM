...
numUserInBinList = pickle.load(open("cessation_numUserInBinList.p","rb"))
...
tenureList = pickle.load(open("cessation_tenureList.p","rb"))
...
#user response post
responsePerUser = pickle.load(open("cessation_responsePerUser.p","rb"))
...
plt.subplots_adjust(wspace = 0.3,hspace = 0.3)#(bottom=0.1, right=0.8, top=0.9)
