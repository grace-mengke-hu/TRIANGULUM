...
numUserInBinList_c = pickle.load(open("cessation_numUserInBinList.p","rb"))
numUserInBinList_v = pickle.load(open("vaping_numUserInBinList.p","rb"))
numUserInBinList_m = pickle.load(open("MJ_numUserInBinList.p","rb"))
numUserInBinList_t = pickle.load(open("tobacco_numUserInBinList.p","rb"))
#tobacco
axs[0,1].plot(np.array(monthlyBin[0:len(monthlyBin)-1]),np.array(numUserInBinList_t),'blue')
...
#vaping
axs[1,1].plot(np.array(monthlyBin[0:len(monthlyBin)-1]),np.array(numUserInBinList_v),'blue')
...
#marijuana
axs[2,1].plot(np.array(monthlyBin[0:len(monthlyBin)-1]),np.array(numUserInBinList_m),'blue')
...
#cessation
axs[3,1].plot(np.array(monthlyBin[0:len(monthlyBin)-1]),np.array(numUserInBinList_c),'blue')
...
axs[1,2].set_xticks(np.arange(0,35,5))
monthLabel = ['0','5','10','15','20','25','30','35']
...
axs[2,2].set_xlim([0,40])
axs[2,2].set_xticks(np.arange(0,35,5))
monthLabel = ['0','5','10','15','20','25','30','35']
...
axs[3,2].set_xlim([0,40])
axs[3,2].set_xticks(np.arange(0,35,5))
monthLabel = ['0','5','10','15','20','25','30','35']
